...
import StockAnalyzerPage from './pages/StockAnalyzerPage.jsx'
  ...
  return (
    <Routes>
      <Route element={<ToolLayout tools={appTools} />}>
        ...
        <Route path="/salary-calculator" element={<SalaryCalculator title="Salary Calculator" />} />
        <Route path="/gst-calculator" element={<GstCalculator title="GST Calculator" />} />
        <Route path="/stock-analyzer" element={<StockAnalyzerPage title="Stock Analyzer" />} />
